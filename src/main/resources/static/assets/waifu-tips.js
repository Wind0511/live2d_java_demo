...
// 后端接口
live2d_settings['modelAPI'] = 'http://localhost:8080/';   // 自建 API 修改这里，这里是本机测试的时候用的，引用的时候请务必修改
...
live2d_settings['homePageUrl'] = 'http://localhost:8080/index';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl'] = 'https://www.fghrsh.net/post/123.html';   // 关于页地址, '{URL 网址}'，飞到大佬的博客去~
    ...
    $.each(result.click, function (index, tips) {
        $(document).on("click", tips.selector, function () {
            ...
            showMessage(text, 3000, true);
                ...
                showMessage("我...变得奇怪了", 3000, true);
            }else {
                showMessage("System:由于CPU过热,系统将由5000ms后关闭", 3000, true);
                window.setTimeout(function () {
                    $('.waifu').hide();
                }, 5000);
            }
